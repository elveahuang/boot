...
import static cc.elvea.boot.commons.utils.ObjectUtils.nvl;
...
public class SpringUtils implements ApplicationContextAware {
     ...
     * 获取转换器
     */
    public static <T> T getConverter(Class<T> clazz) {
        return nvl(applicationContext.getBean(clazz), Mappers.getMapper(clazz));
    }
