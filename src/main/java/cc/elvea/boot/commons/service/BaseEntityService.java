...
public abstract class BaseEntityService<T extends IdEntity, K extends Serializable, R extends BaseRepository<T, K>>
        extends AbstractService implements EntityService<T, K, R> {
    ...
    /**
     * @see EntityService#getRepository()
     */
    @Override
    ...
    /**
     * @see EntityService#getRepositoryClass()
     */
    @Override
