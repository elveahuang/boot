...
public interface CacheService {
     ...
     * 是否空对象
     */
    default <T> boolean isNullValue(@Nullable T obj) {
     ...
     * 创建空对象
     */
    default NullValue newNullValue() {
        return new NullValue();
    }

    /**
     * 返回正常对象值，如果对象是空对象，则返回null的普通类型。
     */
    default <T> T returnVal(T value) {
     ...
     * 是否缓存空值
     */
    default boolean isCacheNullValues(Object value) {
     ...
     * 是否允许缓存
     */
    default boolean allowCacheValues(Object value) {
        return !ObjectUtils.isEmpty(value) || (ObjectUtils.isEmpty(value));
    }
