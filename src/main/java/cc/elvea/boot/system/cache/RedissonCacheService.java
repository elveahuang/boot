...
public class RedissonCacheService implements CacheService {
    ...
    private final int batchSize = CacheConstants.MAX_BATCH_KEY_SIZE;
    ...
    public Set<String> keys(@NonNull String pattern) {
        return Sets.newHashSet(this.redissonClient.getKeys().getKeys(KeysScanOptions.defaults().pattern(pattern)));
    }
